...
import { createListItem, onImageClick, onModalOpen, onChangeLightboxImageUrl, getIndex, setLightboxImageRefAttribute, onShowNextImage, onShowPreviousImage, onCloseModal, onCloseModalByEsc, onCloseLightboxByClick, onClearlightboxImageRef} from './js/script';
